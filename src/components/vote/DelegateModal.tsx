...
export default function DelegateModal({ isOpen, onDismiss, title }: VoteModalProps) {
  ...
  const uniBalance = useTokenBalance(account ?? undefined, chainId ? DOUGH[chainId] : undefined)
      ...
      {!attempting && !hash && (
        <ContentWrapper gap="lg">
          <AutoColumn gap="lg" justify="center">
            ...
            <ThemedText.Body>
              <Trans>Earned DOUGH tokens represent voting shares in Uniswap governance.</Trans>
            </ThemedText.Body>
            <ThemedText.Body>
