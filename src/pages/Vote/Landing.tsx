...
import { DOUGH } from '../../constants/tokens'
...
export default function Landing() {
  ...
  const uniBalance: CurrencyAmount<Token> | undefined = useTokenBalance(
    account ?? undefined,
    chainId ? DOUGH[chainId] : undefined
  )
    ...
    <>
      <PageWrapper gap="lg" justify="center">
              ...
              <AutoColumn gap="md">
                ...
                <RowBetween>
                  <ThemedText.White fontSize={14}>
                    <Trans>
                      DOUGH tokens represent voting shares in Uniswap governance. You can vote on each proposal yourself
                ...
                <ExternalLink
                  ...
                  href="https://doughnutswap.shop/blog/uni"
                  target="_blank"
                >
                  <ThemedText.White fontSize={14}>
        ...
        <ThemedText.SubHeader color="text3">
          <Trans>A minimum threshold of 0.25% of the total DOUGH supply is required to submit proposals</Trans>
