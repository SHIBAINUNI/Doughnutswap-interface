...
export default function CreateProposal() {
  ...
  const [currencyValue, setCurrencyValue] = useState<Currency>(DOUGH[chainId ?? 1])
          ...
          <AutoColumn gap="10px">
            <ThemedText.Link fontWeight={400} color={'primaryText1'}>
              <Trans>
                ...
                <ExternalLink href="https://doughnutswap.shop/docs/v2/governance/governance-reference/#propose">
                  read the docs
                </ExternalLink>
                .
              </Trans>
