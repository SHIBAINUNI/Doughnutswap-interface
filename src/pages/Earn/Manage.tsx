    ...
    <PageWrapper gap="lg" justify="center">
            ...
            <AutoColumn gap="md">
              <RowBetween>
                <ThemedText.White fontWeight={600}>
                  <Trans>Step 1. Get DOUGH-V2 Liquidity tokens</Trans>
                </ThemedText.White>
              </RowBetween>
              <RowBetween style={{ marginBottom: '1rem' }}>
                <ThemedText.White fontSize={14}>
                  <Trans>
                    DOUGH-V2 LP tokens are required. Once you&apos;ve added liquidity to the {currencyA?.symbol}-
      ...
      <PositionInfo gap="lg" justify="center" dim={showAddLiquidityButton}>
            ...
            <CardSection>
              ...
              <AutoColumn gap="md">
                ...
                <RowBetween style={{ alignItems: 'baseline' }}>
                  ...
                  <ThemedText.White>
                    <Trans>
                      DOUGH-V2 {currencyA?.symbol}-{currencyB?.symbol}
                    </Trans>
                  </ThemedText.White>
                </RowBetween>
              </AutoColumn>
          ...
          <StyledBottomCard dim={stakingInfo?.stakedAmount?.equalTo(JSBI.BigInt(0))}>
            ...
            <AutoColumn gap="sm">
              <RowBetween>
                <div>
                  <ThemedText.Black>
                    <Trans>Your unclaimed DOUGH</Trans>
                  </ThemedText.Black>
                </div>
        ...
        <ThemedText.Main style={{ textAlign: 'center' }} fontSize={14}>
          ...
          <Trans>When you withdraw, the contract will automagically claim DOUGH on your behalf!</Trans>
        </ThemedText.Main>
            ...
            {stakingInfo && stakingInfo.active && (
              <ButtonPrimary padding="8px" $borderRadius="8px" width="160px" onClick={handleDepositClick}>
                {stakingInfo?.stakedAmount?.greaterThan(JSBI.BigInt(0)) ? (
                  ...
                  <Trans>Deposit DOUGH-V2 LP Tokens</Trans>
                )}
              </ButtonPrimary>
            )}
        ...
        {!userLiquidityUnstaked ? null : userLiquidityUnstaked.equalTo('0') ? null : !stakingInfo?.active ? null : (
          <ThemedText.Main>
            <Trans>{userLiquidityUnstaked.toSignificant(6)} DOUGH-V2 LP tokens available</Trans>
          </ThemedText.Main>
        )}
      </PositionInfo>
    </PageWrapper>
